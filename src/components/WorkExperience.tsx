...
const workExperienceData = [
  {
    ...
    description: ["Python, React.js, +2 skills"],
    color: "text-blue-400",
  },
  {
    ...
    description: ["Engineering, Software Infrastructure, +3 skills"],
    color: "text-blue-400",
  },
  {
    ...
    location: "Pune, Maharashtra, India",
    description: ["Software Engineering, +2 skills"],
    color: "text-blue-400",
  },
];
...
const WorkExperience = () => {
  return (
    <section
      id="work-experience"
      className="section min-h-screen max-h-screen lg:min-h-[calc(100vh-5rem)] flex items-center justify-center ml-0 lg:ml-10 px-4 font-mono text-base lg:scroll-mt-24 snap-start"
    >
      <div className="w-full max-w-3xl font-medium max-h-dvh overflow-y-auto pb-40">
        <h2 className="text-xl mb-8 lg:hidden text-violet-400 font-normal lowercase">
          work experience
        </h2>
